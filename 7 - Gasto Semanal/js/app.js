...
class UI {
    ...
    insertarPresupuesto(precio) {
        document.querySelector('#total').textContent = precio.presupuesto;
        document.querySelector('#restante').textContent = precio.restante;
    }
...
function agregarGasto(e) {
    ...
    const precio = Number(document.querySelector('#precio').value) * Number(document.querySelector('#cantidad').value);
    ...
    if (nombre === '' || precio === '' || cantidad === '') {
        ...
        // si hay un precio negativa o letras...
        ui.imprimirAlerta('Precio no válido', 'error')
    } else if (cantidad <= 0 || isNaN(cantidad)) {
        // si hay un cantidad negativa o letras...
        ui.imprimirAlerta('Cantidad no válida', 'error')
    } else {
        const gasto = { nombre, precio, cantidad, id: Date.now() };
...
function eliminarGasto(e) {
    if (e.target.classList.contains('borrar-gasto')) {
        ...
        // Pasar el precio restante para actualizar el DOM
        const { restante } = presupuesto;
        ui.actualizarRestante(restante);
